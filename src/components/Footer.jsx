        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 mb-4">
              Discover unforgettable adventures and curated travel experiences
              designed just for you. Explore the world with ease and confidence.
            </p>
          ...
          <div className="flex sm:justify-around justify-between">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#hotel" className="text-gray-400 hover:text-white">
                    Hotel
                  </a>
                </li>
                <li>
